...
def create_tokens_for_user(user_id: str, username: str, role: str) -> Dict[str, str]:
    """Create both access and refresh tokens for a user"""
    access_data = {"sub": user_id, "username": username, "role": role}
    refresh_data = {"sub": user_id, "username": username}
